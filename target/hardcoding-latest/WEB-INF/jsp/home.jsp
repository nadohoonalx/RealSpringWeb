        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="index.html">
                    ...
                    <span><%=System.getProperty("spring.profiles.active") %></span></a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link " href="javascript:getMessage(1)">
                    <i class="fas fa-fw fa-cog"></i>
                    <span>1. JSON by CLASS</span>
                </a>
                 <a class="nav-link " href="javascript:getMessage(3)">
                    <i class="fas fa-fw fa-cog"></i>
                ...
                <span>3. 회원가입</span>
                 ...
                 <a class="nav-link " href="javascript:util.showLoad('/board/writeForm1','4. 글쓰기1');">
                    <i class="fas fa-fw fa-cog"></i>
                    <span>4. 글쓰기1</span>
                </a>
                
                  <a class="nav-link " href="javascript:util.showLoad('/board/writeForm2','5. 글쓰기2');">
                    <i class="fas fa-fw fa-cog"></i>
                    <span>5. 글쓰기2 </span>
                </a>
                
                	<a class="nav-link " href="javascript:util.showLoad('/board/writeForm3','6. 글쓰기3');">
                    <i class="fas fa-fw fa-cog"></i>
                    <span>6. 글쓰기3 </span>
                </a>
            ...
            <li class="nav-item">
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/study/registForm">회원가입2</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3" id ="Projects">
