...
<select id="type" style ="width:140px"></select><br>
    <a href="<c:url value="/study/exception404"/>">404 Error</a> <br>
    <a href="<c:url value="/study/exceptionByZero"/>">By Zero Error</a> <br>
    <a href="<c:url value="/study/registForm" />">회원가입</a><br/>   
    <hr>
    <span id = "menu1" style="cursor:pointer;">404 Error</span><br>
    <span id = "menu2" style="cursor:pointer;">By Zero Error</span><br>
    <span id = "menu3" style="cursor:pointer;">회원가입</span><br>
    <span id = "menu4" style="cursor:pointer;">글쓰기1</span><br>
    <span id = "menu5" style="cursor:pointer;">글쓰기2</span><br>
    <span id = "menu6" style="cursor:pointer;">글쓰기3</span><br>
  </div>
  <div id = "frame" style="width:calc(100%- 202px); width:-moz-calc(100% -202px); 
  width:-webkit-calc(100% - 202px); overflow-y; height:400px; border:solid 1px; float:left;">
  </div>
</body>
</html>
