...
<%--                     <span><%=System.getProperty("spring.profiles.active") %></span> --%>
                    <span>${profile}</span><!-- 얘로 되게 해오기 ctrl+shift+c -->
                    </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link " href="javascript:getMessage(1)">
                 ...
                 <a class="nav-link " href="javascript:util.showload('/nosesion/resistForm','3.회원가입');">
                  ...
                  <a class="nav-link " href="/board/writeForm1"">
                    <i class="fas fa-fw fa-cog"></i>
                    <span>4. 글쓰기1</span>
                </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/study/registForm">회원가입창</a>
